...
define config.name = _("The Sacrifice for Yuristan")
...
define build.name = "TheSacrificeforYuristan"
...
define config.save_directory = "TheSacrificeforYuristan-1760284489"
